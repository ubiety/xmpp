# DisconnectState.Execute Method 
 

\[Missing <summary> documentation for "M:Ubiety.States.DisconnectState.Execute(Ubiety.Common.Tag)"\]
...
#### Parameters
&nbsp;<dl><dt>data (Optional)</dt><dd>Type: <a href="aeb92aed-6e13-96e4-f864-d26234a205c1">Ubiety.Common.Tag</a><br />\[Missing <param name="data"/> documentation for "M:Ubiety.States.DisconnectState.Execute(Ubiety.Common.Tag)"\]</dd></dl>
