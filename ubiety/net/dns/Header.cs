...
namespace ubiety.net.dns
{
	...
	public class Header
	{
		...
		public bool QR
		{
			get { return GetBits(_flags, 15, 1) == 1; }
		...
		public bool AA
		{
			get { return GetBits(_flags, 10, 1) == 1; }
		...
		public bool TC
		{
			get { return GetBits(_flags, 9, 1) == 1; }
		...
		public bool RA
		{
			get { return GetBits(_flags, 7, 1) == 1; }
		...
		public RCode RCODE
		{
			get { return (RCode) GetBits(_flags, 0, 4); }
